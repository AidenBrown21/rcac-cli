...
def execute_tool(name: str, arguments: dict) -> str:
    ...
    try:
        if name == "list_directory":
            ...
            return tool_view_file(arguments["path"], arguments.get("start"), arguments.get("end"))
        elif name == "edit_file":
            return tool_edit_file(arguments["path"], arguments["edits"])
        elif name == "grep_search":
            return tool_grep_search(
                arguments["query"],
                arguments.get("path", "."),
            ...
            return tool_execute_command(
                arguments["command"],
                arguments.get("cwd", None),
                arguments.get("capture_output", True)
            )
        elif name == "build_repo_map":
